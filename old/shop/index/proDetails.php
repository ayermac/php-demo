        ...
        <div class="comWidth">
            ...
            <div class="rightArea">
                ...
                <?php
                    ...
                    ?>
                    <a href="doUserAction.php?act=userlogout">退出</a>
                    <?php
                }else{
                    ?>
            ...
            <div class="description_imgs">
                <div class="big">
                    <a href="../image_800/<?php echo  $proImgs[0]['albumPath'];?>" class="jqzoom" rel='gal1'  title="triumph" >
                        <img width="309" height="340" src="../image_800/<?php  echo $proImgs[0]['albumPath'];?>"  title="triumph">
                    </a>
                </div>
...
<div class="hr_25"></div>
<div class="footer">
    <p><a href="#">简介</a><i>|</i><a href="#">公告</a><i>|</i> <a href="#">招纳贤士</a><i>|</i><a href="#">联系我们</a><i>|</i>客服热线：123456</p>
    <p>Copyright &copy; 2006 - 2014 版权所有&nbsp;&nbsp;&nbsp;京ICP备123456号&nbsp;&nbsp;&nbsp;京ICP证123456号&nbsp;&nbsp;&nbsp;某市公安局XX分局备案编号：123456789123</p>
