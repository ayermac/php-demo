...
<form action="doAdminAction.php?act=editPro&id=<?php echo $id?>" method="post" enctype="multipart/form-data">
    <table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
        ...
        <tr>
            ...
            <td><input type="text" name="pSn"  value="<?php echo $proInfo['pSn']?>" require/></td>
        </tr>
        <tr>
            <td align="right">商品数量</td>
            <td><input type="text" name="pNum"  value="<?php echo $proInfo['pNum']?>" require/></td>
        </tr>
        <tr>
            <td align="right">商品市场价</td>
            <td><input type="text" name="mPrice"  value="<?php echo $proInfo['mPrice']?>" require/></td>
        </tr>
        <tr>
            <td align="right">商品促销价</td>
            <td><input type="text" name="iPrice"  value="<?php echo $proInfo['iPrice']?>" require/></td>
        </tr>
        <tr>
