...
<form action="doAdminAction.php?act=addPro" method="post" enctype="multipart/form-data">
    <table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
        ...
        <tr>
            ...
            <td><input type="text" name="pSn"  placeholder="请输入商品货号" require/></td>
        </tr>
        <tr>
            <td align="right">商品数量</td>
            <td><input type="text" name="pNum"  placeholder="请输入商品数量" require/></td>
        </tr>
        <tr>
            <td align="right">商品市场价</td>
            <td><input type="text" name="mPrice"  placeholder="请输入商品市场价" require/></td>
        </tr>
        <tr>
            <td align="right">商品促销价</td>
            <td><input type="text" name="iPrice"  placeholder="请输入商品慕课价" require/></td>
        </tr>
        <tr>
