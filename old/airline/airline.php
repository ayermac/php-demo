...
<?php
    ...
    // print_r($sxe);
    $citarry = array();
    // print_r($sxe->children()->children());
    foreach ($sxe->children()->children() as $child) {
        # code...
        $citarry[]=$child->cnCityName;
    }
    ...
    if(isset($_POST['Button2'])){
        ...
        $res = $client->getDomesticAirlinesTime($param);
        $airline=$res->getDomesticAirlinesTimeResult->any;
        $sxe = new SimpleXMLElement($airline);
        $airlinearr=array();
        foreach ($sxe->children()->children() as $child) {
            # code...
            $airlinearr[]=$child;
		...
		<td>   
			<form name="form1" method="post" action="" id="form1">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td valign="middle">
                            日期
                    <input name="date" value="2016-10-1" type="text" maxlength="10" size="10" id="date" class="input1" />
                                &nbsp;&nbsp;&nbsp;
